...
__all__ = [
    'SPFM_CREATE_ALWAYS', 'DISPID_SPIEngineId', 'SRAExport',
    'SpNullPhoneConverter', 'DISPID_SMSALineId',
    'DISPID_SLWPronunciations', 'SDTProperty',
    ...
    'SPINTERFERENCE_NOISE', 'SP_VISEME_21', 'SPAS_PAUSE',
    'SPGS_ENABLED', 'DISPID_SPIGetDisplayAttributes',
    'SAFT16kHz16BitMono', 'ISpeechBaseStream', 'SPWT_DISPLAY',
    'SECFNoSpecialChars', 'SPWT_LEXICAL',
    'DISPID_SRGCmdLoadFromMemory', 'SPEI_PHRASE_START',
    'SDTDisplayText', 'eLEXTYPE_MORPHOLOGY', 'SSFMOpenForRead',
    'SP_VISEME_2', 'ISpStreamFormat',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', '_RemotableHandle',
    'SAFT32kHz8BitStereo', 'DISPID_SLGetWords', 'DISPID_SRGReset',
    'SPFM_NUM_MODES', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SpeechRecoResult', 'ISpStream', 'SpeechAudioVolume',
    'ISpeechRecoResult2', 'ISpPhoneticAlphabetConverter',
    'SPLO_STATIC', 'ISpeechRecognizer', 'DISPID_SRRecognizer',
    'ISpeechGrammarRules', 'DISPID_SPIReplacements', 'ISpDataKey',
    'SPEI_START_SR_STREAM', 'DISPID_SGRSTNextState',
    'ISpPhoneConverter', 'SDTAll', 'SPPS_Verb',
    'DISPID_SpeechLexiconPronunciation', 'SGDSActiveUserDelimited',
    'SPEI_TTS_BOOKMARK', 'SGRSTTWildcard', 'DISPID_SpeechVoiceStatus',
    'DISPID_SpeechObjectToken', 'SRAImport',
    'DISPID_SRCCreateResultFromMemory', 'SPPHRASERULE',
    'SAFT32kHz16BitMono', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SVEAudioLevel', 'ISpeechLexiconPronunciation',
    'ISpeechAudioFormat', 'DISPID_SpeechRecoContextEvents',
    'ISpRecognizer', 'SAFT22kHz8BitStereo',
    'DISPID_SRSSupportedLanguages', 'SPSHT_NotOverriden',
    'DISPID_SVSLastBookmarkId', 'DISPID_SPPValue',
    'SDA_One_Trailing_Space', 'DISPID_SVAlertBoundary',
    'SPEI_REQUEST_UI', 'SP_VISEME_7', 'ISpeechPhraseRules', 'SVP_6',
    'SSTTWildcard', 'DISPID_SRCPause', 'DISPID_SRGDictationUnload',
    'DISPID_SpeechMMSysAudio', 'DISPID_SGRSAddWordTransition',
    'ISpPhoneticAlphabetSelection', 'DISPID_SRDisplayUI',
    'SpeechRetainedAudioOptions', 'SPTEXTSELECTIONINFO',
    'eLEXTYPE_PRIVATE4', 'DISPID_SASetState', 'SPGS_DISABLED',
    'ISpeechAudio', 'DISPID_SpeechPhoneConverter', 'ISpRecoResult',
    ...
    'DISPID_SRCResume', 'SPRECORESULTTIMES', 'DISPID_SVSRunningState',
    'DISPID_SpeechAudioFormat', 'SP_VISEME_14', 'DISPID_SAFType',
    'SVSFUnusedFlags', 'SpeechEngineProperties',
    'SAFTExtendedAudioFormat', 'DISPID_SpeechPhraseRules',
    'ISpXMLRecoResult', 'SAFTCCITT_ALaw_8kHzMono',
    ...
    'eLEXTYPE_APP', 'SpeechPropertyHighConfidenceThreshold',
    'SP_VISEME_12', 'SpeechDataKeyLocation',
    'DISPID_SRCEPropertyStringChange', 'SPRECOSTATE',
    'SpeechCategoryPhoneConverters', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SDKGetStringValue', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SVEAudioLevel', 'DISPID_SPAsCount', 'SASStop',
    'eLEXTYPE_PRIVATE7', 'DISPID_SpeechMemoryStream', 'SINone',
    'eLEXTYPE_PRIVATE2', 'ISpeechResourceLoader',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SPPChildren',
    'DISPID_SVVoice', 'SPRULE', 'DISPID_SRGSetWordSequenceData',
    'DISPID_SPRText', 'SPEI_RECO_STATE_CHANGE',
    'DISPID_SpeechDataKey', 'ISpeechPhraseElements',
    'eLEXTYPE_PRIVATE16', 'SP_VISEME_10', 'SPEI_TTS_PRIVATE',
    'SAFTCCITT_ALaw_8kHzStereo', 'SDKLLocalMachine',
    'DISPID_SRGCmdSetRuleState', 'ISpRecoGrammar',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SPEActualConfidence',
    'SPPS_LMA', 'ISpeechObjectTokenCategory', 'SpeechCategoryVoices',
    'DISPID_SCSBaseStream', 'DISPID_SGRSTsItem', 'SPDKL_LocalMachine',
    'SpeechGrammarTagDictation', 'SpeechVoiceSpeakFlags',
    'SpeechUserTraining', 'DISPID_SGRId', 'DISPID_SVEEnginePrivate',
    ...
    'DISPID_SGRsCount', 'SpeechPropertyResourceUsage',
    'SAFTADPCM_22kHzMono', 'SPSUnknown', 'SGSExclusive', 'SPWF_INPUT',
    'DISPID_SASFreeBufferSpace', 'DISPID_SRGetPropertyString',
    'DISPID_SpeechGrammarRules', 'SpeechWordType',
    'SPEVENTSOURCEINFO', 'DISPID_SPERetainedSizeBytes',
    'SPEI_SOUND_START', 'SAFT22kHz8BitMono', 'SECFDefault',
    'DISPID_SpeechLexiconWord', 'SPINTERFERENCE_TOOSLOW',
    'SPEI_RECOGNITION', 'DISPID_SLPs_NewEnum', 'DISPID_SLPsItem',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SPELexicalForm',
    'ISpeechPhraseInfoBuilder', 'SVSFIsNotXML', 'DISPID_SPRs_NewEnum',
    'SREPhraseStart', 'DISPID_SPCIdToPhone', '_ISpeechVoiceEvents',
    'ISpeechPhraseInfo', 'SRCS_Enabled', 'DISPID_SDKSetLongValue',
    'SAFT48kHz16BitMono', 'SpCompressedLexicon', 'SVEBookmark',
    'DISPID_SLRemovePronunciationByPhoneIds', 'eLEXTYPE_PRIVATE15',
    'SREPrivate', 'SVP_12', 'SpNotifyTranslator',
    'DISPID_SRCRecognizer', 'SVP_19', 'DISPID_SGRsDynamic',
    'ISpNotifySink', 'SDA_Two_Trailing_Spaces',
    'DISPID_SDKEnumValues', 'SPEI_SOUND_END', 'SAFTGSM610_8kHzMono',
    'eLEXTYPE_PRIVATE17', 'DISPID_SLRemovePronunciation',
    'SPEI_INTERFERENCE', 'SpeechWordPronounceable', 'SPPHRASE',
    'SVP_3', 'DISPID_SGRSRule', 'DISPIDSPTSI_SelectionLength',
    ...
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SPAPhraseInfo',
    'DISPID_SPIStartTime', 'DISPID_SLWsCount', 'DISPID_SLPPhoneIds',
    'SAFTGSM610_22kHzMono', 'DISPID_SpeechRecoContext', 'SBOPause',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SRCEBookmark',
    'SPWF_SRENGINE', 'DISPID_SVSPhonemeId',
    'ISpeechTextSelectionInformation', 'SPSHT_Unknown', 'SP_VISEME_5',
    'eLEXTYPE_PRIVATE12', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SGRsCommitAndSave', 'SpeechRuleAttributes',
    'SRADefaultToActive', 'DISPID_SpeechPhraseAlternate',
    'SREPropertyStringChange', 'SPFM_CREATE', 'ISpeechObjectTokens',
    'DISPID_SAFSetWaveFormatEx', 'SRAONone', 'SPSTREAMFORMATTYPE',
    'DISPID_SRRAlternates', 'DISPID_SRSCurrentStreamPosition',
    'DISPID_SWFEBlockAlign', 'DISPID_SASCurrentDevicePosition',
    'DISPIDSPRG', 'SpeechAudioState', 'DISPID_SVEventInterests',
    'SpeechCategoryAudioOut', 'DISPID_SRCState',
    'eLEXTYPE_VENDORLEXICON', 'SpeechRunState', 'SAFT11kHz8BitStereo',
    'SVPOver', 'SVSFIsFilename', 'DISPID_SpeechPhraseElements',
    'SPSModifier', 'SPRST_NUM_STATES', 'SVP_4',
    'SAFTCCITT_uLaw_44kHzMono', 'SGRSTTEpsilon', 'ISpeechLexiconWord',
    'DISPID_SPEDisplayText', 'DISPID_SPEDisplayAttributes',
    'ISpRecoCategory', 'SPCATEGORYTYPE', 'DISPID_SABufferInfo',
    'SP_VISEME_17', 'DISPID_SLPLangId', 'SpInprocRecognizer',
    'SpeechGrammarRuleStateTransitionType', 'SRESoundEnd',
    'DISPID_SVSpeakCompleteEvent', 'SP_VISEME_4',
    'DISPID_SDKSetStringValue', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SVSLastBookmark', 'SPXMLRESULTOPTIONS',
    'SAFT44kHz16BitMono', 'DISPID_SRGCommit', 'IEnumString',
    'eLEXTYPE_PRIVATE1', 'SPEI_RESERVED6', 'SRTAutopause', 'SPSLMA',
    'SAFTCCITT_ALaw_11kHzStereo', 'ISpShortcut',
    'SAFT11kHz16BitStereo', 'SPPHRASEELEMENT',
    'DISPID_SGRAddResource', 'DISPID_SVGetVoices',
    'DISPID_SRSCurrentStreamNumber', 'SPAS_STOP', 'SpCustomStream',
    'SREHypothesis', 'DISPID_SVSLastResult', 'DISPID_SVSkip',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SPACommit',
    'SAFTADPCM_44kHzMono', 'tagSPTEXTSELECTIONINFO',
    'STSF_CommonAppData', 'ISpeechGrammarRule', 'DISPID_SVRate',
    'SAFTADPCM_8kHzStereo', 'ISpMMSysAudio', 'SpSharedRecognizer',
    'ISpeechObjectToken', 'SPAR_High', 'ISpEventSink',
    'ISpeechMMSysAudio', 'SAFT11kHz16BitMono', 'DISPID_SGRAttributes',
    'SVP_14', 'SWTDeleted', 'SPEVENT', 'DISPID_SRAudioInput',
    'DISPID_SPIRetainedSizeBytes', 'SPEI_END_SR_STREAM',
    'SPSMF_SAPI_PROPERTIES', 'SASClosed', 'ISpeechPhraseAlternate',
    'SVP_10', 'SREAllEvents', 'DISPID_SpeechCustomStream',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SPRuleName', 'SP_VISEME_13',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SpMMAudioOut',
    'SRTStandard', 'SP_VISEME_0', 'DISPID_SDKGetBinaryValue',
    'SAFTGSM610_44kHzMono', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SABufferNotifySize', 'DISPID_SRGCmdSetRuleIdState',
    'DISPID_SpeechAudioBufferInfo', 'SpeechPropertyAdaptationOn',
    'STSF_AppData', 'DISPID_SPISaveToMemory', 'SAFT22kHz16BitMono',
    'SASRun', 'SpInProcRecoContext', 'DISPID_SRIsShared',
    'DISPID_SpeechObjectTokens', 'ISpRecoContext2',
    'DISPID_SVSVisemeId', 'SPSSuppressWord',
    'ISpeechRecognizerStatus', 'DISPID_SDKGetlongValue',
    'DISPID_SVDisplayUI', 'SpeechEmulationCompareFlags',
    'SPDKL_CurrentConfig', 'eLEXTYPE_PRIVATE19', 'DISPID_SAFGuid',
    'SECLowConfidence', 'SVF_Stressed', 'SAFTGSM610_11kHzMono',
    'SVP_9', 'DISPID_SpeechPhraseReplacements',
    'Speech_Default_Weight', 'SPSEMANTICFORMAT',
    'DISPID_SVAudioOutputStream', 'SVSFParseMask',
    'DISPID_SRSetPropertyNumber', 'SPEI_RECO_OTHER_CONTEXT',
    'SP_VISEME_19', 'SpWaveFormatEx', 'SECFEmulateResult',
    'SPINTERFERENCE_TOOFAST', 'ISpeechCustomStream',
    'DISPID_SRCEPhraseStart', 'eLEXTYPE_PRIVATE11', 'SPLOADOPTIONS',
    'DISPID_SpeechVoice', 'DISPID_SVSpeakStream',
    'DISPID_SMSAMMHandle', 'SpeechFormatType', 'SVSFVoiceMask',
    'DISPID_SPPConfidence', 'SITooQuiet', 'SVSFParseAutodetect',
    'eLEXTYPE_PRIVATE20', 'ISpObjectTokenCategory',
    'SECHighConfidence', 'SVP_2', 'DISPID_SRCEAudioLevel',
    'DISPID_SpeechAudio', 'STCInprocServer', 'SRTSMLTimeout',
    'SLTApp', 'eLEXTYPE_PRIVATE8', 'SGRSTTWord',
    'DISPID_SOTGetDescription', 'SP_VISEME_9',
    'DISPID_SPRuleChildren', 'SpeechCategoryRecoProfiles',
    'SPEI_HYPOTHESIS', 'ISpeechLexiconWords', 'SGDSInactive',
    'SVSFNLPMask', 'SSSPTRelativeToStart',
    'DISPID_SLGetPronunciations', 'SPADAPTATIONRELEVANCE',
    'SPEI_FALSE_RECOGNITION', 'SAFTCCITT_ALaw_11kHzMono', 'SVP_5',
    'SpeechStreamSeekPositionType', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SRCRequestedUIType', 'DISPID_SPRuleConfidence',
    'DISPID_SRRDiscardResultInfo', 'SPLO_DYNAMIC', 'DISPID_SGRSTType',
    'SpStreamFormatConverter', 'SGRSTTRule', 'SAFTADPCM_11kHzStereo',
    'STCLocalServer', 'ISpeechAudioBufferInfo', 'SAFT12kHz8BitMono',
    'DISPID_SpeechRecognizerStatus', 'SPWT_PRONUNCIATION',
    'SPEI_RESERVED3', 'DISPID_SRStatus',
    'DISPID_SPPBRestorePhraseFromMemory', 'SPWORDPRONUNCIATION',
    'SpeechVoicePriority', 'ISpeechPhraseProperties',
    'SpeechDisplayAttributes', 'eLEXTYPE_RESERVED6',
    'DISPID_SPRNumberOfElements', 'SPAUDIOSTATE', 'SPEI_RESERVED1',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SPSHT_EMAIL',
    'ISpeechRecoResultDispatch', 'DISPID_SABIMinNotification',
    'DISPID_SPRuleId', 'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SGRSTText', 'SAFT22kHz16BitStereo', 'SAFTADPCM_11kHzMono',
    'SpeechAudioFormatType', 'SPEI_VOICE_CHANGE', 'SPDATAKEYLOCATION',
    'DISPID_SRCEInterference', 'DISPID_SpeechGrammarRuleState',
    'eLEXTYPE_PRIVATE5', 'DISPID_SVEBookmark', 'SPPHRASEREPLACEMENT',
    'SSTTTextBuffer', 'SRSActive', 'DISPID_SADefaultFormat',
    'SPRECOCONTEXTSTATUS', 'SP_VISEME_3', 'DISPID_SAEventHandle',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SGSDisabled',
    'SSSPTRelativeToEnd', 'SAFT16kHz8BitMono',
    'ISpeechPhraseAlternates', 'DISPID_SVAudioOutput',
    'SPXRO_Alternates_SML', 'ISpLexicon', 'DISPID_SRRAudioFormat',
    'ISpeechRecoContext', 'SPBO_AHEAD', 'DISPID_SAFGetWaveFormatEx',
    'DISPID_SRSetPropertyString', 'SpPhoneConverter',
    'SAFT12kHz16BitStereo', 'SAFTText', 'DISPID_SRRPhraseInfo',
    'DISPID_SRRGetXMLResult', 'SPPS_Interjection', 'DISPID_SLWLangId',
    'SPBOOKMARKOPTIONS', 'DISPID_SPPsItem', 'DISPID_SBSWrite',
    'SRERecognition', 'DISPID_SPERequiredConfidence',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SPILanguageId',
    'SPRST_INACTIVE', 'SPSVerb', 'DISPID_SPIAudioStreamPosition',
    'DISPIDSPTSI_ActiveLength', 'ISpeechXMLRecoResult',
    'SAFTCCITT_uLaw_22kHzMono', 'ISpRecoGrammar2',
    'DISPID_SRCEFalseRecognition', 'ISpResourceManager',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SpeechAudioStatus',
    'ISpSerializeState', 'DISPID_SRCEHypothesis', 'DISPID_SGRsAdd',
    'SPPS_Unknown', 'DISPID_SPEAudioStreamOffset',
    ...
    'SP_VISEME_11', 'SREAdaptation', 'DISPIDSPTSI', 'SGSEnabled',
    'DISPID_SRRRecoContext', 'DISPID_SVPriority', 'SPSNotOverriden',
    'ISpeechPhraseProperty', 'SRTExtendableParse', 'SAFTDefault',
    'SPFILEMODE', 'DISPID_SLWType', 'SPRS_INACTIVE',
    'DISPID_SRSAudioStatus', 'SREBookmark',
    'SAFTCCITT_ALaw_22kHzMono', 'ISpVoice', 'DISPID_SOTCSetId',
    'DISPID_SPPs_NewEnum', 'DISPID_SOTRemove', 'SRCS_Disabled',
    'DISPID_SpeechPhraseProperty', 'SP_VISEME_20', 'DISPID_SAVolume',
    'ISpeechAudioStatus', 'Speech_Max_Word_Length',
    'DISPID_SPPsCount', 'STSF_LocalAppData', 'SREStateChange',
    'eLEXTYPE_PRIVATE9', 'DISPID_SOTCategory', 'SP_VISEME_8',
    'DISPID_SVIsUISupported', 'DISPID_SPIGetText', 'STCAll',
    'SPINTERFERENCE_TOOQUIET', 'SRATopLevel', 'SASPause',
    'SpeechMicTraining', 'SPEI_PHONEME', 'DISPID_SPEAudioSizeTime',
    'SWPUnknownWordUnpronounceable', 'SPSInterjection',
    'SPEI_SR_BOOKMARK', 'SpUnCompressedLexicon',
    'DISPID_SABIEventBias', 'DISPID_SDKDeleteValue', 'DISPID_SPPName',
    'SPEI_MIN_TTS', 'DISPID_SVSInputWordPosition',
    'DISPID_SRGetPropertyNumber',
    'DISPID_SLAddPronunciationByPhoneIds', 'STSF_FlagCreate',
    'SPPS_RESERVED4', 'SREAudioLevel', 'SVSFIsXML',
    'ISpeechPhraseRule', 'DISPID_SRCERecognizerStateChange',
    'DISPID_SVSInputSentenceLength', 'DISPID_SPIRule', 'SP_VISEME_1',
    'ISpObjectToken', 'DISPID_SRRTOffsetFromStart', 'SPRS_ACTIVE',
    'SPSERIALIZEDPHRASE', 'DISPID_SPAsItem', 'DISPID_SPCLangId',
    'SVP_15', 'SPDKL_CurrentUser', 'Speech_StreamPos_RealTime',
    'SRSEIsSpeaking', 'SGRSTTDictation',
    'DISPID_SRGDictationSetState', 'DISPID_SDKCreateKey',
    'SVEPhoneme', 'eLEXTYPE_PRIVATE14', 'SpeechRuleState', 'SPAR_Low',
    'SPEI_MIN_SR', 'SPINTERFERENCE', 'DISPID_SpeechPhraseBuilder',
    ...
    'DISPID_SVGetProfiles', 'DISPID_SPRDisplayAttributes',
    'SpeechRecognizerState', 'DISPID_SRGIsPronounceable',
    'DISPID_SGRAddState', 'SPCS_DISABLED', 'SPFM_OPEN_READONLY',
    'SREStreamEnd', 'DISPID_SVStatus', 'SVF_Emphasis',
    'DISPID_SVGetAudioOutputs', 'SPEI_RESERVED5', 'SP_VISEME_18',
    'SRARoot', 'DISPID_SPEEngineConfidence',
    '_ISpeechRecoContextEvents', 'SPWORDLIST', 'SDTAudio',
    'DISPID_SOTCreateInstance', 'SDTReplacement',
    'SpeechAddRemoveWord', 'SPSHT_OTHER', 'DISPID_SOTCGetDataKey',
    'SITooFast', 'SpeechRecoContextState', 'SPGS_EXCLUSIVE',
    'DISPID_SGRSTsCount', 'ISpProperties',
    'DISPID_SRCreateRecoContext', 'SPAR_Medium', 'SVP_8',
    'ISpeechRecoGrammar', 'SRADynamic', 'SPVOICESTATUS',
    'DISPID_SRRTStreamTime', 'SAFT44kHz8BitStereo',
    'DISPID_SRCEventInterests', 'SITooSlow', 'SPLEXICONTYPE',
    'SRAInterpreter', 'SPEI_MAX_SR', 'SVF_None',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SASState', 'SFTSREngine',
    'SVP_20', 'DISPID_SOTDataKey', 'SpeechEngineConfidence',
    'SDTRule', 'ISpeechPhraseReplacements', 'SpeechAllElements',
    'IEnumSpObjectTokens', 'SPSEMANTICERRORINFO',
    'SPINTERFERENCE_NONE', 'SWPKnownWordPronounceable',
    'SPDKL_DefaultLocation', 'DISPID_SRSClsidEngine',
    'SVSFPurgeBeforeSpeak', 'DISPID_SRIsUISupported',
    'SPPS_RESERVED1', 'DISPID_SRGDictationLoad', 'SAFT24kHz16BitMono',
    'SPSERIALIZEDRESULT', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SPAStartElementInResult',
    'DISPID_SRAudioInputStream', 'SpResourceManager',
    'SDA_Consume_Leading_Spaces', 'SpeechDiscardType',
    'SPCONTEXTSTATE', 'SREStreamStart', 'DISPID_SRCESoundEnd',
    'ISequentialStream', 'SpeechBookmarkOptions', 'DISPID_SPPParent',
    'DISPID_SRCVoicePurgeEvent', 'SpeechLexiconType',
    'SpeechStreamFileMode', 'ISpeechFileStream',
    'SAFT24kHz16BitStereo', 'SpSharedRecoContext', 'ISpNotifySource',
    'DISPID_SPRFirstElement', 'SPPHRASEPROPERTY',
    'SPFM_OPEN_READWRITE', 'eLEXTYPE_PRIVATE10', 'SPPARTOFSPEECH',
    'SAFT16kHz8BitStereo', 'SPEI_RESERVED2', 'SPEVENTENUM',
    'SPRST_INACTIVE_WITH_PURGE', 'SINoise', 'DISPID_SVResume',
    'SPSHORTCUTPAIRLIST', 'SPWORDPRONUNCIATIONLIST',
    ...
    'SAFTCCITT_uLaw_11kHzMono', 'SpTextSelectionInformation',
    'DISPID_SpeechLexicon', 'SPCT_DICTATION',
    'DISPID_SASNonBlockingIO', 'SPVPRI_OVER', 'ISpeechVoiceStatus',
    'SpMMAudioEnum', 'SpeechVisemeFeature', 'DISPID_SLPType',
    'DISPID_SPEsCount', 'SpeechAudioFormatGUIDText', 'SPAUDIOOPTIONS',
    'SPPS_RESERVED3', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SRRTimes', 'DISPID_SOTId', 'SPGRAMMARSTATE',
    'SECNormalConfidence', 'SRAORetainAudio',
    'DISPID_SRRSaveToMemory', 'ISpeechRecoResultTimes',
    'DISPID_SRRTLength', 'DISPID_SGRSTPropertyId', 'SPWORDTYPE',
    'ISpeechMemoryStream', 'DISPID_SOTsItem', 'DISPID_SPRuleParent',
    'UINT_PTR', 'SRTEmulated',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SAFTNoAssignedFormat',
    'DISPID_SRRGetXMLErrorInfo', 'WAVEFORMATEX',
    ...
    'DISPID_SPRsItem', 'DISPID_SGRSTransitions',
    'ISpNotifyTranslator', 'SPEI_SR_RETAINEDAUDIO', 'ISpRecognizer2',
    'DISPID_SRCEAdaptation', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SRGetRecognizers', 'SpeechLoadOption',
    'eLEXTYPE_RESERVED9', 'SRSInactiveWithPurge', 'SAFT44kHz8BitMono',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SRCRetainedAudio',
    'DISPID_SBSSeek', 'DISPID_SOTCDefault', 'DISPID_SRCVoice',
    'SGDisplay', 'SpeechRegistryUserRoot', 'DISPID_SPIProperties',
    'DISPID_SDKOpenKey', 'SpMMAudioIn', 'SPAO_RETAIN_AUDIO',
    'DISPID_SPEsItem', 'DISPID_SLPsCount', 'DISPID_SLGenerationId',
    'SpeechTokenContext', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SPIEnginePrivateData', 'SPWORD', 'ISpeechRecoResult',
    'DISPID_SVESentenceBoundary', 'DISPID_SRGRecoContext',
    'SLODynamic', 'SDKLDefaultLocation', 'SINoSignal',
    'DISPID_SPIAudioSizeTime', 'SPPS_NotOverriden', 'DISPID_SFSClose',
    'SSFMCreateForWrite', 'DISPID_SPEAudioSizeBytes', 'SWTAdded',
    'SPEI_START_INPUT_STREAM', 'DISPID_SLPPartOfSpeech',
    'DISPID_SPRulesCount', 'SpeechTokenKeyUI', 'DISPID_SPCPhoneToId',
    'SPVPRIORITY', 'DISPID_SDKEnumKeys', 'SVPNormal', 'SVSFParseSsml',
    'SpeechInterference', 'SpeechCategoryRecognizers',
    'DISPID_SVSCurrentStreamNumber', 'SAFT24kHz8BitStereo',
    'SpStream', 'SRESoundStart', 'DISPID_SVEWord',
    'DISPID_SWFEChannels', 'DISPID_SRGId', 'eLEXTYPE_PRIVATE6',
    'SAFT8kHz16BitStereo', 'ISpObjectWithToken',
    'DISPID_SRSNumberOfActiveRules', 'SAFTADPCM_44kHzStereo',
    'SpPhraseInfoBuilder', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SRRAudio', 'SVESentenceBoundary', 'SpeechCategoryAudioIn',
    'SVSFPersistXML', 'SAFT32kHz16BitStereo', 'SVSFDefault',
    'SREFalseRecognition', 'DISPID_SMSSetData', 'SSTTDictation',
    'SpMemoryStream', 'DISPID_SPEPronunciation',
    'SPEI_SR_AUDIO_LEVEL', 'IStream', 'DISPID_SMSADeviceId',
    'eLEXTYPE_PRIVATE3', 'SAFTCCITT_uLaw_22kHzStereo', 'SPBO_PAUSE',
    'DISPID_SRRTTickCount', 'SRSActiveAlways',
    'Speech_StreamPos_Asap', 'SpeechPropertyResponseSpeed', 'SVP_1',
    'SpeechGrammarTagWildcard',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SpAudioFormat',
    'DISPID_SABIBufferSize', 'DISPID_SpeechLexiconProns',
    'DISPID_SVPause', 'SP_VISEME_16', 'DISPID_SPARecoResult',
    'DISPID_SpeechLexiconWords', 'DISPID_SPEs_NewEnum',
    'SGLexicalNoSpecialChars', 'SDTLexicalForm',
    'IInternetSecurityManager', 'SPPS_Function',
    'SAFTCCITT_uLaw_8kHzMono', 'SPCT_SUB_DICTATION',
    'DISPID_SOTMatchesAttributes', 'DISPID_SVWaitUntilDone',
    'DISPID_SpeechPhraseRule', 'ISpeechLexicon', 'SPEI_VISEME',
    'DISPID_SRCERequestUI', 'DISPID_SRCCmdMaxAlternates',
    'SpeechVoiceEvents', 'DISPID_SGRs_NewEnum', 'eWORDTYPE_ADDED',
    'DISPID_SOTSetId', 'DISPID_SOTIsUISupported',
    'DISPID_SGRSTWeight', '_SPAUDIOSTATE',
    'SpeechDictationTopicSpelling', 'DISPID_SLWsItem',
    'SAFTADPCM_8kHzMono', 'DISPID_SPRulesItem',
    'SpeechAudioProperties', 'DISPID_SOTRemoveStorageFileName',
    'SAFT24kHz8BitMono', 'SVEViseme', 'SPRST_ACTIVE',
    'DISPID_SRGCmdLoadFromResource', 'SAFT48kHz16BitStereo',
    'eLEXTYPE_USER', 'DISPID_SPRuleFirstElement', 'eWORDTYPE_DELETED',
    'DISPID_SOTCId', 'ISpRecoContext', 'SpLexicon', 'tagSTATSTG',
    '__MIDL_IWinTypes_0009', 'SPPROPERTYINFO',
    'DISPID_SGRSTPropertyValue', 'ISpeechPhraseReplacement',
    'SPCT_SLEEP', 'eLEXTYPE_RESERVED4', 'SDTPronunciation',
    'ISpeechDataKey', 'SPAR_Unknown', 'DISPID_SRGState',
    'SPVPRI_NORMAL', 'SGRSTTTextBuffer', 'SAFT11kHz8BitMono',
    'DISPID_SBSFormat', 'SVEAllEvents',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SRGRules',
    'SPPS_Noun', 'DISPID_SRGSetTextSelection',
    'SAFTCCITT_ALaw_22kHzStereo', 'SPAS_RUN', 'DISPID_SBSRead',
    'DISPID_SpeechGrammarRuleStateTransition', 'DISPID_SRProfile',
    'ISpeechVoice', 'SGDSActiveWithAutoPause', 'SPSNoun',
    'SpShortcut', 'DISPID_SRCSetAdaptationData', 'SRTReSent',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SFSOpen',
    'SAFT44kHz16BitStereo', 'ISpPhrase', 'DISPID_SRCERecognition',
    'SVP_21', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SPRS_ACTIVE_USER_DELIMITED', 'SPSHORTCUTPAIR',
    'SpeechPropertyNormalConfidenceThreshold', 'SpFileStream',
    'ISpeechLexiconPronunciations', 'DISPID_SGRName',
    'DISPID_SpeechPhraseProperties', 'SPAS_CLOSED', 'SPVISEMES',
    'eLEXTYPE_RESERVED10', 'DISPID_SPANumberOfElementsInResult',
    'SLOStatic', 'SP_VISEME_6', 'eLEXTYPE_PRIVATE13',
    'DISPID_SLAddPronunciation', 'SPPS_RESERVED2',
    'DISPID_SpeechPhraseInfo', 'SpeechGrammarWordType', 'SVP_0',
    'DISPID_SVEStreamEnd', 'DISPID_SRCEPropertyNumberChange',
    'SAFT12kHz16BitMono', 'SVP_17', 'SVP_16', 'DISPID_SVEStreamStart',
    'SPCT_SUB_COMMAND', 'DISPID_SDKDeleteKey',
    'DISPID_SpeechRecognizer', 'SAFT48kHz8BitMono', 'SVPAlert',
    'SSFMCreate', 'ISpAudio', 'DISPID_SVEPhoneme',
    'DISPID_SVSInputSentencePosition', 'DISPID_SPPFirstElement',
    'SPBO_TIME_UNITS', 'SpeechRecognitionType',
    'DISPID_SRCAudioInInterferenceStatus', 'IInternetSecurityMgrSite',
    'SPCT_COMMAND', 'SAFTCCITT_ALaw_44kHzMono',
    'DISPID_SVEVoiceChange', 'DISPIDSPTSI_ActiveOffset',
    'SAFT16kHz16BitStereo', 'SPAUDIOBUFFERINFO', 'SGDSActive',
    'SVEPrivate', 'DISPID_SPRsCount', 'ISpEventSource', 'SPBO_NONE',
    'SVP_18', 'SPVPRI_ALERT', 'SpeechGrammarState', 'SPAO_NONE',
    'STCRemoteServer', 'SPEI_SR_PRIVATE', 'DISPID_SVSInputWordLength',
    'SPSFunction', 'eLEXTYPE_RESERVED7',
    'SpeechRecoProfileProperties', 'DISPID_SWFEFormatTag', 'SLTUser',
    'DISPID_SGRsItem', 'SPXRO_SML', 'SAFT12kHz8BitStereo',
    'DISPID_SRCESoundStart', 'ISpPhraseAlt', 'ISpeechPhoneConverter',
    'DISPID_SRCRetainedAudioFormat', 'SGLexical', 'tagSPPROPERTYINFO',
    'SECFIgnoreCase', 'SDKLCurrentConfig', 'SPAUDIOSTATUS',
    'SRSEDone', 'SpeechVisemeType', 'SpeechRecoEvents',
    'SPPS_SuppressWord', 'SPCS_ENABLED', 'SVEEndInputStream',
    'SPINTERFERENCE_TOOLOUD', 'SpeechTokenValueCLSID',
    'DISPID_SpeechRecoResult2', 'DISPID_SRCEEndStream',
    'DISPID_SLWs_NewEnum', 'DISPID_SOTsCount', 'SRSInactive',
    'SPGRAMMARWORDTYPE', 'SVSFlagsAsync', 'DISPID_SpeechGrammarRule',
    'DISPID_SVVolume', 'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SPIAudioSizeBytes', 'ISpGrammarBuilder', 'SVSFParseSapi',
    ...
    'DISPID_SOTGetStorageFileName', 'SpeechSpecialTransitionType',
    'DISPID_SRGetFormat', 'SpeechTokenKeyAttributes',
    'SPPS_Noncontent', 'DISPID_SGRSTPropertyName', 'SREInterference',
    'DISPID_SPPEngineConfidence', 'SPRULESTATE',
    'DISPID_SRRSetTextFeedback', 'SVEVoiceChange', 'STCInprocHandler',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SRERecoOtherContext', 'SBONone', 'DISPID_SPIElements',
    'SpeechRegistryLocalMachineRoot', 'ISpStreamFormatConverter',
    'SPINTERFERENCE_NOSIGNAL', 'SPSHORTCUTTYPE', 'ISpRecognizer3',
    'SVP_7', 'DISPID_SREmulateRecognition', 'SFTInput',
    'SRERequestUI', 'DISPID_SRCCreateGrammar', 'SDKLCurrentUser',
    'SVP_13', 'SVSFNLPSpeakPunc', 'SDTAlternates', 'SPEI_ADAPTATION',
    'DISPID_SpeechBaseStream', 'SECFIgnoreKanaType',
    'DISPID_SOTGetAttribute', 'DISPID_SGRsFindRule', 'DISPID_SPPId',
    'DISPID_SpeechPhraseReplacement', 'SDA_No_Trailing_Space',
    'DISPID_SpeechPhraseAlternates', 'SSSPTRelativeToCurrentPosition',
    'SPPS_Modifier', 'SVP_11', 'ISpeechWaveFormatEx',
    'DISPID_SRCEEnginePrivate', 'SpVoice', 'SpeechTokenKeyFiles',
    'SAFTCCITT_ALaw_44kHzStereo', 'SGPronounciation',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SpObjectToken',
    'SAFT48kHz8BitStereo', 'SAFTADPCM_22kHzStereo', 'LONG_PTR',
    'DISPID_SOTDisplayUI', 'DISPID_SAStatus', 'SPEI_UNDEFINED',
    'DISPID_SVEViseme', 'SECFIgnoreWidth', 'SpeechPartOfSpeech',
    'SPEI_END_INPUT_STREAM', 'SITooLoud', 'DISPID_SPAs_NewEnum',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SP_VISEME_15',
    'DISPID_SLPSymbolic'
]

_check_version('1.1.14', 1633528325.393060)
